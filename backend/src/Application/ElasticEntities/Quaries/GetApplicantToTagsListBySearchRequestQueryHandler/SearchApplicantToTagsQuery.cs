...
namespace Application.ElasticEnities.Quaries.GetApplicantToTagsListBySearchRequestQueryHandler
{
    ...
    {
         public GetApplicantToTagsListBySearchRequestQueryHandler(IElasticReadRepository<entities::ElasticEntity> repository, IMapper mapper) : base(repository, mapper) { }
    }
}