namespace Application.Common.Mail
{
    public static class MailBodyFactory
    {
        ...
        public static readonly string CONFIRM_APPLY_VACANCY = "<p>Hello!<br>To confirm your applying for vacancy {{VACANCY}}, follow the <a href='{{CALLBACK}}'>link</a><br>If you have not requested this letter, please ignore this message.</p><p>Best regards, Scout team</p>";
    }
}
