namespace Application.Common.Mail
{
    public static class MailBodyFactory
    {
        ...
        public static readonly string FORGOT_PASSWORD = "Hello!<br>To reset the password for your Scout account, follow the link <a href='{{CALLBACK}}'>link</a><br>If you have not requested a password change, please ignore this message.";
