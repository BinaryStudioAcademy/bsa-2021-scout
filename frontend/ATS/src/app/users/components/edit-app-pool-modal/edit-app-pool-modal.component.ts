...
export class EditAppPoolModalComponent implements OnInit {
  ...
  public allapplicants: Applicant[] = [
    ...
    //  {id: '4',firstName : 'Vladimir', lastName: 'Lenin', email:'ivan@email.com', vacancies: []},
    //  {id: '5',firstName : 'Alex', lastName: 'Sergeev', email:'ivan@email.com', vacancies: []},
    //  {id: '6',firstName : 'Ivan', lastName: 'Notch', email:'ivan@email.com', vacancies: []},
  ];
  ...
  add(event: MatChipInputEvent): void {
    ...
    let app = this.applicants.find(
      (x) => x.id === value && x.lastName === value,
    );
  ...
  selected(event: MatAutocompleteSelectedEvent): void {
    ...
    let app = this.allapplicants.find(
      (x) => `done ${x.firstName} ${x.lastName}` === value,
    );
